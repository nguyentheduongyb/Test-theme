...
const CartItem = ({ item, handleSelect, selectAll, handleLoadAgain }: any) => {
                        ...
                        <div className="bg-[#ffff] rounded text-sm  mb-4">
                                ...
                                <div className="px-4 pb-4">
                                        <div className="border rounded">
                                                <div className="px-3 py-4">{item.product.promotion && item.product.promotion}<button className="ml-3">Thêm {`>`}</button></div>
                                                <div className="px-4 py-4 flex items-center">
                                                        <Checkbox className="mr-6" checked={checked && true} onChange={handleChecked} />
                                                        <div className="flex justify-between flex-1 items-center">
                                                                <div className="flex-1 flex gap-2 items-center">
                                                                        <div className="w-20 h-20 bg-no-repeat bg-cover bg-center" style={{ backgroundImage: `url("${item.product.image}")` }}></div>
